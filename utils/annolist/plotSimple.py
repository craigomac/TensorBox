...
import random
import re
from utils.annolist.AnnotationLib import *
from utils.annolist.MatPlotter import *
...
def main(argv):
    ...
    parser.add_option("-c", "--components", action="store", dest="ncomponents", type="int",
                      help="show n trailing components of the part", default=3)
    parser.add_option("--cut-trailing", action="store", dest="cutcomponents", type="int",
                      help="cut n trailing components of the part (applied after --components)", default=-1)
